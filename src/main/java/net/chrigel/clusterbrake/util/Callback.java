 ...
 * the <code>call</code> method, with the second parameter specifying the return type of the method.
 *
...
public interface Callback<P, R> {
    ...
    /**
     * The <code>call</code> method is called when required, and is given a single argument of type P, with a
     * requirement that an object of type R is returned.
     *
